...
<head>
	...
	<link href="./assets/css/app.css?1010" rel="stylesheet" type="text/css"/>
	<link href="./assets/css/email-subscribers.css" rel="stylesheet" type="text/css"/>
	<link href="./assets/css/recruitment_detail.css?120" rel="stylesheet" type="text/css"/>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-sidebar-closed-hide-logo page-footer-fixed">
	...
	<div class="page-header navbar navbar-fixed-top">
		...
		<div class="page-header-inner">
			...
			<div class="page-logo">
				<a href="index.jsp">
					<img src="./assets/logos/logo_header.png" alt="logo" style="margin: 15px 10px 0 10px; width: 107px;" class="logo-default"/>
				</a>
							...
							<section class="single_job">
								...
								<c:if test="${param.work_type eq '3'}">
									...
									<div class="row">
										<div class="small-12 columns">
											...
											<div id="client_job_positions" class="recruitment_narration">
												<i class="fas fa-sync fa-spin"> </i>
											</div>
								...
								<div class="row">
									...
									<div class="small-12 large-6 columns">
										<label style="font-size: 15px;"> <span style="font-size: 14px;font-weight: bold;">What's your email address?*</span><br><br>
											...
											width: 330px;
											padding: 8px;">
											<input id="nf-field-4" onclick="job_application()" class="ninja-forms-field nf-element" type="button" value="APPLY NOW" style="background-color: #0072b8;
											color: white;
											border: none;
											padding: 8px;">
										</label>
...
<script type="text/javascript" src="./assets/js/recruitment_detail.js?1021"></script>
