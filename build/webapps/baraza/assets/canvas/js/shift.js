...
/**
 * React like state for storing data
 * for search
 * @returns 
 */
function useState() {
...
function next(isPageSet = false) {
    ...
    console.log('next() currentPage ',currentPage, 'weekName ', weekName, ' START_WEEK ', START_WEEK, ' LAST_WEEK ', LAST_WEEK, 'Page Number', pageNumber);
