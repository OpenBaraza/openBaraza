...
<div class="page-header navbar navbar-fixed-top" style="border-bottom: none;background-color: #fafafa;">
	...
	<div class="page-header-inner">
		...
		<h2 style="font-weight: bold;color:#0072b8;margin-left: 45%;">OUR COURSES</h2>
...
<script type="text/javascript" src="./assets/js/trainings.js?1092"></script>
...
<script>
	...
	function scrollFunction() {
	  if (document.body.scrollTop > 50 || document.documentElement.scrollTop > 50) {
		document.getElementById("pagehead").style.height = "60px";
	  } else {
		document.getElementById("pagehead").style.height = "160px";
	  }
	}
</script>
