...
<c:set var="mainPage" value="confirmation.jsp" scope="page" />
...
int optId = 0;
String msg1 = "Wrong Confirmation code";
String msg2 = "Kindly check on your link again";

if(code != null) {
	String mySql = "SELECT application_id FROM applications WHERE (confirmation_code = '" + code + "')";
	String appId = db.executeFunction(mySql);
	
	if(appId == null) {
		mySql = "SELECT intern_id FROM interns WHERE (confirmation_code = '" + code + "')";
		appId = db.executeFunction(mySql);
		
		if(appId != null) {
			mySql = "UPDATE interns SET is_confirmed = true WHERE (confirmation_code = '" + code + "') AND (is_confirmed = false)";
			db.executeUpdate(mySql);
			optId = 2;
			msg1 = "Congratulations for taking your first step to the right path.";
			msg2 = "Your Internship application is acknowledged, kindly login and update your details";
		}
	} else {
		mySql = "UPDATE applications SET is_confirmed = true WHERE (confirmation_code = '" + code + "') AND (is_confirmed = false)";
		db.executeUpdate(mySql);
		optId = 1;
		msg1 = "Congratulations for taking your first step to the right path.";
		msg2 = "Your Job application is acknowledged, kindly login and update your details";
	}
}
...
<head>
	...
	<link href="../assets/admin/layout4/css/custom.css?1050" rel="stylesheet" type="text/css"/>
...
<!-- BEGIN HEADER -->
<div class="pheader" style="display: flex;
align-items: center;
background-color: #fafafa;
position: sticky;
top: -60px; /* Equal to the height difference between header-outer and header-inner */
height: 120px;z-index: 9995;">
<div class="page-header navbar navbar-fixed-top" style="border-bottom: none;background-color: #fafafa;">
	<!-- BEGIN HEADER INNER -->
...
<h2 style="
    margin-bottom: -50px;
    margin-left: 45%;font-weight: bold;color:#0072b8">Confirmation page</h2>
</div>
				...
				<div class="portlet light bordered">
					<div class="portlet-title">
					    <div class="caption font-green-sharp">
					        ...
					        <span class="caption-helper">Confirmation Details</span>
					    </div>
					    <div class="actions">
...
<div class="page-footer">
	<div class="page-footer-inner">
		2023 &copy; openBaraza <a href="http://dewcis.com">Dew Cis Solutions Ltd</a> All Rights Reserved
	</div>
