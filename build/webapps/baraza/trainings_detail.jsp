...
<head>
	...
	<link href="./assets/admin/layout4/css/custom.css?1070" rel="stylesheet" type="text/css"/>
...
<div class="page-header navbar navbar-fixed-top" style="border-bottom: none;background-color: #fafafa;">
	...
	<div class="page-header-inner">
		<!-- BEGIN LOGO -->
		<div class="page-logo" style="height: 60px;margin-top: -20px;">
			<a href="index.jsp">
		...
		<h2 style="font-weight: bold;color:#0072b8;margin-left: 45%;">COURSE TOPICS</h2>
...
<!-- BEGIN CONTAINER -->
<div class="page-container" style="margin-top: 60px;background-color: white;">
    <div class="page-sidebar-wrapper">
		<!-- DOC: Set data-auto-scroll="false" to disable the sidebar from auto scrolling/focusing -->
		<!-- DOC: Change data-auto-speed="200" to adjust the sub menu slide up/down speed -->
		
	</div>
	<a href="./trainings.jsp"><button class="backbtn">← BACK TO COURSES</button></a>
	<!-- <a href="./course_details.jsp"><button class="backbtn" style="float:right;margin-right: 20px;padding-right:10px;padding-left: 10px;">REGISTER FOR COURSE</button></a> -->
	<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="col-md-6 col-sm-12" style="width:100%">
			<div class="row">
				<!-- BEGIN Portlet PORTLET-->
				<div class="portlet light bordered" style="border: none !important;box-shadow: none;padding-top: 0px;">
					...
					<div class="portlet-body">
						...
						<section class="results">
							<div class="row">
							    <div class="small-cols" id="job_list" style="display: flex;flex-wrap:wrap;row-gap: 40px;">
...
<script type="text/javascript" src="./assets/js/trainings_detail.js?1092"></script>
