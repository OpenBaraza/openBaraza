...
public class webdav {
	...
	public static void main(String args[]) {
		String path = "http://ndovu:8080/repository/webdav/agency/";
		webdav wd = new webdav(path, "repository", "baraza");
		wd.listDir("");
	
		File nf = new File("../../../build/webapps/repository/pictures/README");
		wd.saveFile(nf, "README");
	}
